...
describe("Test account parse", () => {
    test("Test unknown account", () => {
        expect(() => index_1.BaseAccount.fromProtoJSON({})).toThrow();
        const account = index_1.BaseAccount.fromProtoJSON({}, "cosmos1vv6hruquzpty4xpks9znkw8gys5x4nsnqw9f4k");
    ...
    test("Test fromAminoJSON", () => {
        ...
        expect(account.getAddress()).toBe("desmos1smwe5mmpnvda8pe5mh6le4agrvg6ts8z4zywy6");
